...
export default function Home() {
 ...
 <button 
 onClick={() => navigate('/login')}
 className="bg-blue-600 hover:bg-blue-700 text-white text-sm font-medium px-5 py-2.5 rounded-full transition hover:"
 >
 Get Started
 </button>
 </div>
 ...
 <button 
 onClick={() => navigate('/login')}
 className="w-full sm:w-auto bg-blue-600 hover:bg-blue-700 text-white text-lg font-medium px-8 py-4 rounded-full transition -600/20 flex items-center justify-center"
 >
 Create Free Account
 ...
 <div className="bg-white p-8 rounded-md border border-gray-100 text-center hover: transition">
